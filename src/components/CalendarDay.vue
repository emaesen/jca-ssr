      ...
      <div class="events">
        <div class="events-container" v-if="onCalendar">
          <div
            ...
            :class="[{allday: !event.time.start && !event.time.end, recurring: isRecurring(event), postponed: event.flag && event.flag.is_postponed, canceled: event.flag && event.flag.is_canceled}, 'event_cat-'+event.category, 'event_type-'+event.type]"
          ...
          >
            ...
            <span v-if="event.flag && event.flag.is_outdoors && !(event.flag && event.flag.is_canceled) && !event.stamp" class="deemph">
              OUTDOORS
            </span>
