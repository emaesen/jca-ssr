  ...
  <div>
    ...
    <div>
      <div class="intro"  v-animate-on-intersection>
        ...
        However, they moved to another space in June of 2023 and this has put great pressure on the JCA and its ability to be sustainable.
        ...
        <br>
        Please help us keep our doors open to forward thinking, arts education, collaboration and COMMUNITY. We need one another more than ever these days. Thanks to you for seeing that, knowing that and choosing to be a part of the JCA family.
        <br><span class="xbr"></span>
        YOU ARE CORE TO US.
      </div>
      ...
      <div class="script center anima__slide-in-from-left"  v-animate-on-intersection>
        You are not only supporting the ARTS,
        <br><span class="xbr"></span>
        you are supporting the culture of our community.
        <br><span class="xbr"></span>
        Please join us in being a sustaining member of the JCA.
        <br><span class="xbr"></span>
      ...
      <div class="details anima__slide-in-from-left"  v-animate-on-intersection>
        ...
        <br><span class="xbr"></span>
        Not only will a contribution help support programming, it is VITAL to the well-being of the culture of our community.
      </div>
